      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: `${cityName}, ${stateName} mental health directory preview`,
        },
      ],
    },
  };
...
export default async function CityPage({ params }: CityPageProps) {
  ...
  const webpageSchema = {
    "@context": "https://schema.org",
    "@type": "WebPage",
    name: `Mental Health Services in ${cityName}, ${stateName}`,
    ...
    about: [
      {
        "@type": "Thing",
        name: `${cityName} mental health services`,
      },
      {
        "@type": "Thing",
    ...
    <main className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <header className="space-y-4">
        ...
        <h1 className="text-3xl font-semibold text-navy">
          Mental Health Services in {cityName}, {stateName}
        </h1>
