      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: `${stateName} mental health directory preview`,
        },
      ],
    },
  };
...
export default async function StatePage({ params }: StatePageProps) {
  ...
  const careTypesText = (["mental health services"] as const).join(", ");
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: `How many mental health services are in ${stateName}?`,
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: `What types of mental health services are available in ${stateName}?`,
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const webpageSchema = {
    "@context": "https://schema.org",
    "@type": "WebPage",
    name: `Mental Health Services in ${stateName}`,
    ...
    about: [
      {
        "@type": "Thing",
        name: `${stateName} mental health services`,
      },
      {
        "@type": "Thing",
    ...
    <main className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <section className="rounded-2xl bg-navy px-5 py-6 text-surface shadow-lg shadow-navy/30 ring-1 ring-gold/40 sm:px-8 sm:py-8">
        ...
        <h1 className="mt-2 text-3xl font-semibold sm:text-4xl">
          Mental Health Services in {stateName}
        </h1>
        <p className="mt-3 max-w-2xl text-sm text-surface/80">
          ...
          >
            official {stateName} mental health resources
          </a>{" "}
          for licensing, inspections, and family support programs.
        </p>
        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <h2 className="text-sm font-semibold uppercase tracking-[0.18em] text-navy border-b-2 border-teal/50 pb-1 inline-block">
              Mental Health Services by City in {stateName}
            </h2>
