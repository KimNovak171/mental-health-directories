...
export const metadata: Metadata = {
  title: "Advertise | Get Your Practice in Front of Families Who Are Ready to Choose",
  description:
    "Featured and premium listings on MentalHealthDirectories.com. Reach families actively researching mental health options across the United States.",
  alternates: {
    canonical: "/advertise",
    languages: {
      "en-us": "https://mentalhealthdirectories.com/advertise",
    },
  },
  openGraph: {
    title: "Advertise | Get Your Practice in Front of Families Who Are Ready to Choose",
    description:
      "A featured listing puts your practice at the top of your city section and in front of high-intent visitors at the moment they are making a care decision.",
    url: "/advertise",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "MentalHealthDirectories.com advertise page preview",
      },
    ],
  },
};
    ...
    <main className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <header className="space-y-3">
        ...
        <p className="max-w-3xl text-sm text-slate-600">
          MentalHealthDirectories.com is visited by families actively researching
          mental health options across the United States. A featured listing puts
          your practice at the top of your city section and in front of
          high-intent visitors at the moment they are making a care decision.
        </p>
      </header>
